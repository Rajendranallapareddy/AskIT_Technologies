...
router.get(
  ...
  trainerController.getParticipants
);

router.post(
  '/internships/:id/materials',
  uploadMaterial.single('file'),
  trainerController.uploadMaterial
);

router.get(
  '/internships/:id/materials',
  trainerController.listMaterials
);

router.delete(
  '/materials/:id',
  trainerController.deleteMaterial
);

router.post(
  '/internships/:id/announcements',
  trainerController.postAnnouncement
);

router.post(
  '/internships/:internshipId/sessions',
