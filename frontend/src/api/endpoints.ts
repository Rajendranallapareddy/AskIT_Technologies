...
export const userApi = {
  ...
  downloadCertificate: (
    ...
    apiClient.get(
      `/users/certificates/${id}/download`
    ),
...
export const trainerApi = {
  ...
  participants: (
    ...
    apiClient.get(
      `/trainer/internships/${internshipId}/participants`
    ),
  ...
  markAttendance: (
    ...
    apiClient.post(
      `/trainer/sessions/${sessionId}/mark`,
      {
        records,
      }
    ),
  ...
  postAnnouncement: (
    ...
    apiClient.post(
      `/trainer/internships/${internshipId}/announcements`,
      data
    ),
};
...
export const adminApi = {
  ...
  registrations: (
    ...
    apiClient.get(
      `/admin/internships/${internshipId}/registrations`,
      {
        params,
      }
    ),
...
export const paymentApi = {
  ...
  downloadReceipt: (
    ...
    apiClient.get(
      `/payments/receipts/${paymentId}/download`
    ),
  ...
  payInstallment: (
    ...
    apiClient.post(
      `/payments/installments/${paymentId}/pay`
    ),

  manualAccounts: () =>
    apiClient.get(
      '/payments/manual-accounts'
    ),
  ...
  switchToManual: (
    ...
    apiClient.put(
      `/payments/${paymentId}/switch-to-manual`
    ),
...
export const adminPaymentApi = {
  ...
  exportUrl: (
    ...
    `/api/admin/payments/export?${new URLSearchParams(
      params
    ).toString()}`,
  ...
  resendReceipt: (
    ...
    apiClient.post(
      `/admin/payments/${id}/resend-receipt`
    ),
  ...
  studentHistory: (
    ...
    apiClient.get(
      `/admin/payments/student/${userId}`
    ),

  updateInternshipPricing: (
    id: string,
    data: any
  ) =>
    apiClient.put(
      `/admin/internships/${id}/pricing`,
      data
    ),
...
export const paymentAccountApi = {
  ...
  update: (
    ...
    return apiClient.put(
      `/superadmin/payment-accounts/${id}`,
      formData,
      {
        headers: {
          'Content-Type':
  ...
  toggle: (
    ...
    apiClient.put(
      `/superadmin/payment-accounts/${id}/toggle`
    ),
...
export const superAdminApi = {
  ...
  updatePermissions: (
    ...
    apiClient.put(
      `/superadmin/sub-admins/${id}/permissions`,
      permissions
    ),
  ...
  deactivateSubAdmin: (
    ...
    apiClient.put(
      `/superadmin/sub-admins/${id}/deactivate`
    ),
  ...
  activateSubAdmin: (
    ...
    apiClient.put(
      `/superadmin/sub-admins/${id}/activate`
    ),
  ...
  resetSubAdminPassword: (
    ...
    apiClient.put(
      `/superadmin/sub-admins/${id}/reset-password`,
      {
        newPassword,
      }
    ),
