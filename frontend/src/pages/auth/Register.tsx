...
export default function Register() {
  ...
  const getRegistrationError = (err: any): string => {
    ...
    if (err.response.status >= 500) {
      return 'Something went wrong while sending the verification OTP. Please try again later.';
    }
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      toast.success(
        'Verification OTP sent to your email. Your account will be created only after OTP verification.'
      );
